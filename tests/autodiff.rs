...
impl Div<Num> for Num {
    ...
    fn div(self, _rhs: Num) -> Num {
        Num {
            val: self.val / _rhs.val,
            eps: (self.eps * _rhs.val - self.val * _rhs.eps) / (_rhs.val * _rhs.val),
        }
    }
}
...
impl FloatConst for Num {
    ...
    fn FRAC_1_PI() -> Num {
        Num {
            val: f64::consts::FRAC_1_PI,
            eps: 0.0,
        }
    }
    fn FRAC_1_SQRT_2() -> Num {
        Num {
            val: f64::consts::FRAC_1_SQRT_2,
            eps: 0.0,
        }
    }
    fn FRAC_2_PI() -> Num {
        Num {
            val: f64::consts::FRAC_2_PI,
            eps: 0.0,
        }
    }
    fn FRAC_2_SQRT_PI() -> Num {
        Num {
            val: f64::consts::FRAC_2_SQRT_PI,
            eps: 0.0,
        }
    }
    fn FRAC_PI_2() -> Num {
        Num {
            val: f64::consts::FRAC_PI_2,
            eps: 0.0,
        }
    }
    fn FRAC_PI_3() -> Num {
        Num {
            val: f64::consts::FRAC_PI_3,
            eps: 0.0,
        }
    }
    fn FRAC_PI_4() -> Num {
        Num {
            val: f64::consts::FRAC_PI_4,
            eps: 0.0,
        }
    }
    fn FRAC_PI_6() -> Num {
        Num {
            val: f64::consts::FRAC_PI_6,
            eps: 0.0,
        }
    }
    fn FRAC_PI_8() -> Num {
        Num {
            val: f64::consts::FRAC_PI_8,
            eps: 0.0,
        }
    }
    fn LN_10() -> Num {
        Num {
            val: f64::consts::LN_10,
            eps: 0.0,
        }
    }
    fn LN_2() -> Num {
    ...
    fn LOG10_E() -> Num {
        Num {
            val: f64::consts::LOG10_E,
            eps: 0.0,
        }
    }
    fn LOG2_E() -> Num {
        Num {
            val: f64::consts::LOG2_E,
            eps: 0.0,
        }
    }
    fn PI() -> Num {
...
impl Float for Num {
    ...
    fn is_nan(self) -> bool {
        self.val.is_nan() || self.eps.is_nan()
    }
    fn is_infinite(self) -> bool {
        self.val.is_infinite() || self.eps.is_infinite()
    }
    fn is_finite(self) -> bool {
        self.val.is_finite() && self.eps.is_finite()
    }
    fn is_normal(self) -> bool {
        self.val.is_normal() && self.eps.is_normal()
    }
    ...
    fn recip(self) -> Num {
        Num {
            val: self.val.recip(),
            eps: -self.eps / (self.val * self.val),
        }
    }
    ...
    fn powf(self, n: Num) -> Num {
        Num {
            ...
            eps: (Float::ln(self.val) * n.eps + n.val * self.eps / self.val)
                * Float::powf(self.val, n.val),
        }
    }
    fn sqrt(self) -> Num {
        Num {
            val: self.val.sqrt(),
            eps: self.eps * 0.5 / self.val.sqrt(),
        }
    }

    fn exp(self) -> Num {
        Num {
            val: Float::exp(self.val),
            eps: self.eps * Float::exp(self.val),
        }
    }
    fn exp2(self) -> Num {
        Num {
            val: Float::exp2(self.val),
            eps: self.eps * Float::ln(2.0) * Float::exp(self.val),
        }
    }
    fn ln(self) -> Num {
        Num {
            val: Float::ln(self.val),
            eps: self.eps * self.val.recip(),
        }
    }
    fn log(self, b: Num) -> Num {
        Num {
            val: Float::log(self.val, b.val),
            eps: -Float::ln(self.val) * b.eps / (b.val * Float::powi(Float::ln(b.val), 2))
                + self.eps / (self.val * Float::ln(b.val)),
        }
    }
    fn log2(self) -> Num {
        Float::log(self, Num { val: 2.0, eps: 0.0 })
    }
    fn log10(self) -> Num {
        Float::log(
            self,
    ...
    fn max(self, other: Num) -> Num {
        Num {
            val: Float::max(self.val, other.val),
            eps: 0.0,
        }
    }
    fn min(self, other: Num) -> Num {
        Num {
            val: Float::min(self.val, other.val),
            eps: 0.0,
        }
    }
    fn abs_sub(self, other: Num) -> Num {
        if self > other {
            Num {
                val: Float::abs_sub(self.val, other.val),
                eps: (self - other).eps,
            }
        } else {
            Num { val: 0.0, eps: 0.0 }
    ...
    fn cbrt(self) -> Num {
        Num {
            val: Float::cbrt(self.val),
            eps: 1.0 / 3.0 * self.val.powf(-2.0 / 3.0) * self.eps,
        }
    }
    ...
    fn sin(self) -> Num {
        Num {
            val: Float::sin(self.val),
            eps: self.eps * Float::cos(self.val),
        }
    }
    fn cos(self) -> Num {
        Num {
            val: Float::cos(self.val),
            eps: -self.eps * Float::sin(self.val),
        }
    }
    fn tan(self) -> Num {
        ...
        Num {
            val: t,
            eps: self.eps * (t * t + 1.0),
        }
    }
    fn asin(self) -> Num {
        Num {
            val: Float::asin(self.val),
            eps: self.eps / Float::sqrt(1.0 - Float::powi(self.val, 2)),
        }
    }
    fn acos(self) -> Num {
        Num {
            val: Float::acos(self.val),
            eps: -self.eps / Float::sqrt(1.0 - Float::powi(self.val, 2)),
        }
    }
    fn atan(self) -> Num {
        Num {
            val: Float::atan(self.val),
            eps: self.eps / Float::sqrt(Float::powi(self.val, 2) + 1.0),
        }
    }
    fn atan2(self, other: Num) -> Num {
        Num {
            val: Float::atan2(self.val, other.val),
            eps: (other.val * self.eps - self.val * other.eps)
                / (Float::powi(self.val, 2) + Float::powi(other.val, 2)),
        }
    }
    ...
    fn exp_m1(self) -> Num {
        Num {
            val: Float::exp_m1(self.val),
            eps: self.eps * Float::exp(self.val),
        }
    }
    fn ln_1p(self) -> Num {
        Num {
            val: Float::ln_1p(self.val),
            eps: self.eps / (self.val + 1.0),
        }
    }
    fn sinh(self) -> Num {
        Num {
            val: Float::sinh(self.val),
            eps: self.eps * Float::cosh(self.val),
        }
    }
    fn cosh(self) -> Num {
        Num {
            val: Float::cosh(self.val),
            eps: self.eps * Float::sinh(self.val),
        }
    }
    fn tanh(self) -> Num {
        Num {
            val: Float::tanh(self.val),
            eps: self.eps * (1.0 - Float::powi(Float::tanh(self.val), 2)),
        }
    }
    fn asinh(self) -> Num {
        Num {
            val: Float::asinh(self.val),
            eps: self.eps * (Float::powi(self.val, 2) + 1.0),
        }
    }
    fn acosh(self) -> Num {
        Num {
            val: Float::acosh(self.val),
            eps: self.eps * (Float::powi(self.val, 2) - 1.0),
        }
    }
    fn atanh(self) -> Num {
        Num {
            val: Float::atanh(self.val),
            eps: self.eps * (-Float::powi(self.val, 2) + 1.0),
        }
    }
    ...
    fn to_degrees(self) -> Num {
        Num {
            val: Float::to_degrees(self.val),
            eps: 0.0,
        }
    }
    fn to_radians(self) -> Num {
        Num {
            val: Float::to_radians(self.val),
            eps: 0.0,
        }
    }
}
